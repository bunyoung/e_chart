...
<!-- Font Awesome -->
<!-- <link rel="stylesheet" href="./assets/lib/font-awesome-4.6.3/css/all.css"/> -->
...
<!-- multi selection -->     
<link rel="stylesheet" href="assets/css/fastselect.css"/>
<!-- bootstrap-switch -->     
<link rel="stylesheet" href="assets/css/bootstrap-switch.css"/>
<!-- js/bootstrap-toggle  -->     
<!-- <link rel="stylesheet" href="assets/lib/bootstrap-toggle-master/css/bootstrap-toggle.min.css"/> -->
<!-- pageloder -->   
<link rel="stylesheet" href="assets/css/jquery.pageLoading.css"/>
...
<script type="text/javascript" src="assets/js/jquery-2.1.3.js">
</script>


 <script type="application/javascript" src="assets/js/jquery.table2excel.min.js"></script>

<!-- pageloder -->   
<script type="text/javascript" src="assets/js/jquery.pageLoading.js">
</script><!-- page loder --> 
...
<!--Modernizr-->
<script type="text/javascript" src="assets/lib/modernizr/modernizr.min.js">
</script>
<!--Chart-->
<!-- <script type="text/javascript" src="./assets/lib/highcharts/lib/highcharts.js">
</script>
<script type="text/javascript" src="./assets/lib/highcharts/lib/highcharts-3d.src.js">
</script>
<script type="text/javascript" src="./assets/lib/highcharts/lib/modules/data.js">
</script>
<script type="text/javascript"  src="./assets/lib/highcharts/lib/modules/exporting.js">
</script>  -->
<!--TABLE  -->
...
<!-- <script type="text/javascript" src="./assets/js/jquery.stickytable.css">
</script>
<script type="text/javascript" src="./assets/js/jquery.stickytable.js">
</script>
<script type="text/javascript" src="./assets/js/jquery.stickytable.min.css">
</script>
<script type="text/javascript" src="./assets/js/jquery.stickytable.min.js">
</script>  -->
...
<script src="assets/lib/jquery-inputlimiter/jquery.inputlimiter.1.3.1.min.js">
</script>
<script src="assets/lib/jQuery.validVal/js/jquery.validVal.min.js">
</script>
<script src="assets/lib/bootstrap-daterangepicker/daterangepicker.js">
</script>
<!-- thai extension -->
...
<script type="text/javascript" src="assets/js/bootstrap-timepicker.min.js">
</script>
<script type="text/javascript" src="assets/js/bootstrap-datepicker-thai.js">
</script> 
<script type="text/javascript" src="assets/js/locales/bootstrap-datepicker.th.js">
</script>
<!-- Metis core scripts -->
...
<!-- js/bootstrap-toggle  -->     
<!-- <script type="text/javascript" src="assets/lib/bootstrap-toggle-master/js/bootstrap-toggle.min.js">
</script>  -->
<!-- multi selection -->     
<script type="text/javascript" src="assets/js/fastselect.standalone.js">
</script>  
<!-- serch autocomplete -->
<link rel="stylesheet" href="assets/css/autocomplete.css" type="text/css"/>
<script type="text/javascript" src="assets/js/autocomplete.js">
</script>
