            ...
            <div class="topnav">
                ...
                <div class="btn-group">
                    <form id="login" class="form-inline" action="authen.php" method="post">
                        <input class="form-control input-sm" name="username" type="text" placeholder="USERNAME" tabindex="1">
                        <input class="form-control input-sm" name="password" type="password" placeholder="PASSWORD" tabindex="2">
            ...
            <div id="div3" class="span12">
              <div class="text-center">
                <ul class="stats_box">
                  ...
                  <li>
                    <div class="icons collapse in" >
                      <a class="btn btn-primary btn-rect btn-line" href="#" target=""
                        data-toggle="tooltip"  title="ส่งกลับ">
