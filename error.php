...
?>
    ...
    function coolRedirect(url, msg) {
        ...
        var DEF_MSG =
            "<div class='text-center'><a  class='label label-danger' href='#login' data-toggle='tab' >ระบบกำลังพากลับไปหน้า LOGIN ใหม่อีกครั้ง</a></div>"; // ตั้งรูปแบบของตัวอักษรตอนบอกว่ากำลัง REDIRECT หน้าอยู่
...
<body class="" alt="noisy_grid" onload="coolRedirect('dashboard.php')">

    <div class="loginwrapper">
        <div class="loginwrap zindex100 animate2 bounceInDown">
            <h1 class="logintitle"><span class="iconfa-warning-sign"></span> <strong>
                    <font color="#ff1117">ERROR</font>
                </strong> <span class="subtitle">
                    <font color="#ff1117">ไม่สามารถเข้าใช้งานระบบได้</font>
                </span></h1>
